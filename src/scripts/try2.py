...
def get_next_speech(): 
  ...
  f.write(now.strftime("2 got text-%H:%M:%S,  "))
  f.close()
  ...
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("2 got index-%H:%M:%S, "))
  f.close()
  ...
  if state=="x":
    ...
    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarabv22.blend')           

  elif state=="v":              
          
    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarab2.blend')
  elif state=="y":               

    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarabv32.blend')           

  elif state=="z":
          
    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarabv42.blend')
  ...
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("2 got fix context-%H:%M:%S, "))
  f.close()
  ...
  soundstrip = scene.sequence_editor.sequences.new_sound("say", "/home/enas/catkin_ws/src/multiprocess_render/src/audio/say2.mp3", 2, newindex)
  ...
  bpy.data.scenes["Scene"].quicktalk_script_file="/home/enas/catkin_ws/src/multiprocess_render/src/txtscript/script12.txt"
  bpy.data.scenes["Scene"].quicktalk_dict_file="/home/enas/catkin_ws/src/multiprocess_render/src/txtscript/standard_dictionary2"
  ...
  bpy.data.scenes["Scene"].render.filepath="/home/enas/catkin_ws/src/multiprocess_render/src/video/yes3.mp4"#argv[0]

  bpy.data.scenes["Scene"].frame_start=newindex+x
  bpy.data.scenes["Scene"].frame_end=newindex+y
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("2 before render-%H:%M:%S, "))
  f.close()
  ...
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("2 render-%H:%M:%S, "))
  f.close()
  subprocess.Popen(shlex.split("rostopic pub /render1/show3 std_msgs/String /home/enas/catkin_ws/src/multiprocess_render/src/video/yes3.mp4,x,"+str(x)+","+str(y)+",/render1/show3"), stdout=subprocess.PIPE)
  process.stdout.close
