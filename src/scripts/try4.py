...
def get_next_speech(): 
  ...
  f.write(now.strftime("4 got text-%H:%M:%S, "))
  f.close()
  ...
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("4 got index-%H:%M:%S,  "))
  f.close()
  ...
  if state=="x":
    ...
    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarabv24.blend')           
 
  elif state=="v":              
          
     bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarab4.blend')
  elif state=="y":               

    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarabv34.blend')           

  elif state=="z":
          
    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarabv44.blend')
  ...
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("4 got fix context-%H:%M:%S,  "))
  f.close()
  x=int(float(argv[0]))
  y=int(float(argv[1]))
  newindex=(index+16)*24

  soundstrip = scene.sequence_editor.sequences.new_sound("say", "/home/enas/catkin_ws/src/multiprocess_render/src/audio/say4.mp3", 2, newindex)
  ...
  bpy.data.scenes["Scene"].quicktalk_script_file="/home/enas/catkin_ws/src/multiprocess_render/src/txtscript/script14.txt"
  bpy.data.scenes["Scene"].quicktalk_dict_file="/home/enas/catkin_ws/src/multiprocess_render/src/txtscript/standard_dictionary4"
  ...
  bpy.data.scenes["Scene"].render.filepath="/home/enas/catkin_ws/src/multiprocess_render/src/video/yes5.mp4"#argv[0]
  ...
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("4 before render-%H:%M:%S,  "))
  f.close()
  bpy.ops.render.opengl(animation=True)
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("4 render-%H:%M:%S, "))
  f.close()

  subprocess.Popen(shlex.split("rostopic pub /render1/show5 std_msgs/String /home/enas/catkin_ws/src/multiprocess_render/src/video/yes5.mp4,x,"+str(x)+","+str(y)+",/render1/show5"), stdout=subprocess.PIPE)
  process.stdout.close
