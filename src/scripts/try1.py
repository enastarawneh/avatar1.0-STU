...
def get_next_speech(): 
  ...
  f.write(now.strftime("1 got text-%H:%M:%S, "))
  f.close() 
  ...
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("1 got index-%H:%M:%S ,"))
  f.close()
  ...
  if state=="x":
    ...
    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarabv21.blend')           

  elif state=="v":              
          
    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarab1.blend')
  elif state=="y":               

    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarabv31.blend')           

  elif state=="z":
          
    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarabv41.blend')
  ...
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("1 got fix context-%H:%M:%S ,"))
  f.close()
  ...
  soundstrip = scene.sequence_editor.sequences.new_sound("say", "/home/enas/catkin_ws/src/multiprocess_render/src/audio/say1.mp3", 2, newindex)
  ...
  bpy.data.scenes["Scene"].quicktalk_script_file="/home/enas/catkin_ws/src/multiprocess_render/src/txtscript/script11.txt"
  bpy.data.scenes["Scene"].quicktalk_dict_file="/home/enas/catkin_ws/src/multiprocess_render/src/txtscript/standard_dictionary1"
  ...
  bpy.data.scenes["Scene"].render.filepath="/home/enas/catkin_ws/src/multiprocess_render/src/video/yes2.mp4"#argv[0]
  ...
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("1before render-%H:%M:%S, "))
  f.close()
  bpy.ops.render.opengl(animation=True)
  f= open("/home/enas/text.txt","a")
  
  now = datetime.datetime.now() 
  f.write(now.strftime("1 render-%H:%M:%S, "))
  f.close()

  subprocess.Popen(shlex.split("rostopic pub /render1/show2 std_msgs/String /home/enas/catkin_ws/src/multiprocess_render/src/video/yes2.mp4,x,"+str(x)+","+str(y)+",/render1/show2"), stdout=subprocess.PIPE)
  process.stdout.close
