...
def get_next_speech(): 
  ...
  f.write(now.strftime("3 got text-%H:%M:%S, "))
  f.close()
  ...
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("3 got index-%H:%M:%S,  "))
  f.close()
  ...
  if state=="x":
    ...
    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarabv23.blend')           

  elif state=="v":              
          
    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarab3.blend')
  elif state=="y":               

    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarabv33.blend')           

  elif state=="z":
          
    bpy.ops.wm.open_mainfile(filepath='/home/enas/blender-files/arab-guy/lipsynctarabv43.blend')
  ...
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("3 got fix context-%H:%M:%,  "))
  f.close()
  ...
  soundstrip = scene.sequence_editor.sequences.new_sound("say", "/home/enas/catkin_ws/src/multiprocess_render/src/audio/say3.mp3", 2, newindex)
  ...
  bpy.data.scenes["Scene"].quicktalk_script_file="/home/enas/catkin_ws/src/multiprocess_render/src/txtscript/script13.txt"
  bpy.data.scenes["Scene"].quicktalk_dict_file="/home/enas/catkin_ws/src/multiprocess_render/src/txtscript/standard_dictionary3"
  ...
  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("3 before render-%H:%M:%S, "))
  f.close()
  bpy.ops.render.opengl(animation=True)

  f= open("/home/enas/text.txt","a")
  now = datetime.datetime.now() 
  f.write(now.strftime("3 render-%H:%M:%S, "))
  f.close()

  subprocess.Popen(shlex.split("rostopic pub /render1/show4 std_msgs/String /home/enas/catkin_ws/src/multiprocess_render/src/video/yes4.mp4,x,"+str(x)+","+str(y)+",/render1/show4"), stdout=subprocess.PIPE)
  process.stdout.close
