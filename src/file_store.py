...
class file_store:
    ...
    def my_function(self, var1,var2, x):
     
        shutil.copy(var1, "/home/enas/catkin_ws/src/multiprocess_render/src/txtscript/script1"+str(x)+".txt")
        shutil.copy(var2, "/home/enas/catkin_ws/src/multiprocess_render/src/audio/say"+str(x)+".mp3") 
    ...
    def callback(self, data):
     ...
     if  newone != str(data.data): 
        ...
        pool.map(self.multi_run_wrapper, [(dist1,dist2,0),(dist1,dist2,1),(dist1,dist2,2),(dist1,dist2,3),(dist1,dist2,4),(dist1,dist2,5)])
